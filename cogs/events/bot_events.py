...
class BotEvents:
    ...
    async def on_member_join(self, member):
        ...
        try:
            ...
            new_mem_msg = f'{member.name} joined {member.server} on {datetime.datetime.now()}'
            ...
            given_role_msg = f"{member.name} given Mortal role in {member.server} on {datetime.datetime.now()}"
